# Contributing to @plasius/item-crafting
...
`@plasius/item-crafting` provides apprenticeship-gated item-crafting access and authority boundary contracts for Plasius.

Contributions typically fall into crafting-access contracts, discipline metadata, workshop readiness helpers, docs, tests, and tooling quality.
