...
## Scope
- This repository contains `@plasius/item-crafting`.
- The package provides apprenticeship-gated item-crafting access and authority boundary contracts for Plasius.
